...
faq:
  - question: "How many times a week should I strength train after 30?"
    answer: "Three days a week is the sweet spot for most people with a job and a life. Two is a genuine floor that still produces progress if the sessions are full-body and the intensity is real. Four works for people whose recovery, sleep, and schedule actually support it. More than that is a small minority, not a default."
  - question: "Is two days a week enough to build strength?"
    answer: "Yes, if both sessions are full-body and you're actually pushing close to a hard set. Two well-run sessions beat four rushed ones. The people who stall on two days a week usually aren't stalling because of frequency, they're stalling because the load never changes."
  - question: "Can training too often make you weaker after 30?"
    answer: "It can, though the mechanism is recovery rather than age itself. Adding days without adding sleep, food, or reducing per-session volume means you accumulate fatigue faster than you clear it. The tell is performance drifting down over weeks while effort feels higher."
  - question: "How do I know when to add a training day?"
    answer: "When your current frequency has stopped feeling hard to recover from, your lifts are still progressing, and the extra day doesn't come out of your sleep. If any of those three isn't true, adding a day usually costs more than it returns."
---
...
The second is sarcopenia. Starting somewhere in the early thirties, you start losing muscle mass at a rate of roughly half a percent to one percent per year if you do nothing. By sixty, that's a meaningful amount of strength gone, and most people don't notice it until a chair or a flight of stairs points it out. If you want a read on where you stand now, there's a [four-part sarcopenia self-test](/training/sarcopenia-self-test-at-home-am-i-losing-muscle-after-50) with clinical cutoffs you can run at home. Strength training is the most effective intervention for stopping this, and the dose-response curve flattens out fast. Two well-programmed sessions per week deliver most of the available benefit. The third session adds a meaningful but smaller increment. The fourth and fifth, for someone whose goal is just to stay strong and healthy, often doesn't add much at all.
