...
faq:
  - question: "How do I start lifting again after a long break?"
    answer: "Start lighter than your ego wants and ramp over about four weeks. The first sessions should feel easy, because the limiting factor isn't muscle, it's connective tissue and technique, and both come back slower than strength does. Most people who get hurt coming back got hurt in week one."
  - question: "How much strength do you lose during a break?"
    answer: "Less than people fear, and it returns faster than it was built the first time. What fades quickest is work capacity and technical sharpness, not the underlying muscle. The bigger risk is that tendons and joints detrain faster than your confidence does."
  - question: "How long does it take to get back to where I was?"
    answer: "For a break of a few months, usually a matter of weeks, not the months it took originally. Longer layoffs take longer, and breaks caused by injury follow a different path because there's a specific tissue that needs rebuilding rather than just general detraining."
  - question: "Is coming back at 40 different from coming back at 25?"
    answer: "The direction is the same; the ramp needs to be longer. Recovery between sessions takes more time and connective tissue adapts more slowly, so the four-week re-entry that a 25-year-old can compress into one is worth actually spreading out."
---
...
Joint complaints that escalate session over session. A little stiffness in the first few sessions is normal and clears with movement. Sharp localized joint pain, especially that lingers between sessions, is the signal to drop the loads back to last week's levels and hold there. The [pain triage I use to tell soreness from injury](/training/injury-vs-soreness-when-to-train-through-pain-over-30) is the cleanest filter for the gray-zone calls.
