...
faq:
  - question: "How do I tell the difference between soreness and injury?"
    answer: "Soreness is usually diffuse, symmetrical, worse a day or two after, and eases as you warm up. Injury tends to be sharp, localized, one-sided, and gets worse as you load it rather than better. If it's changing how you move without you deciding to, treat it as injury until proven otherwise."
  - question: "Should I train through pain?"
    answer: "Mild, familiar discomfort that settles as you warm up and doesn't linger the next day is usually fine to work around. Pain that increases with load, wakes you at night, or comes with swelling is not something to push through. The useful question isn't whether it hurts, it's how it behaves over the next 24 hours."
  - question: "What are red flags that mean stop training today?"
    answer: "Sharp pain that arrives suddenly, swelling, a joint giving way or locking, numbness or tingling into a limb, and any pain following a fall or collision. Those want assessment rather than modification."
  - question: "When should I see a physio instead of managing it myself?"
    answer: "A reasonable rule is 72 hours: if something isn't clearly improving in that window, or it's limiting normal daily movement, get eyes on it. Waiting months to see whether an ache resolves on its own is how a two-week problem becomes a six-month one."
---
...
If you've already been through physical therapy and the question now is how to get back to your old training, that's a different gap and it's covered separately in the [post-PT bridge guide](/training/personal-trainer-for-injury-recovery-bridge-from-physical-therapy).
