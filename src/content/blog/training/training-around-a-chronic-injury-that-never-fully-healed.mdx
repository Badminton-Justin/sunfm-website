...
faq:
  - question: "Can I keep training with an injury that never fully healed?"
    answer: "Usually yes, and stopping entirely often makes it worse over time because the area gets weaker and the rest of the body compensates around it. The work is sorting what you can load directly, what you load around, and what you leave alone for now."
  - question: "How do I tell a flare-up from a new injury?"
    answer: "A flare-up is familiar: same location, same character, settles on a timeline you recognise. A new problem feels different, sits somewhere else, or behaves in a way this injury never has. A compensation pattern usually shows up somewhere adjacent, on the side you've been protecting."
  - question: "Why do some injuries never fully heal?"
    answer: "Often because the original problem resolved but the movement pattern built around it never got rebuilt. The body finds a way to avoid loading the area, that avoidance becomes habitual, and the tissue stays underprepared indefinitely. That's a training problem rather than a healing problem."
  - question: "How do I start loading an old injury again?"
    answer: "Gradually, with a reintroduction over about four weeks, and with a clear rule for how much next-day response is acceptable. The usual benchmark is that discomfort settles back to baseline within 24 hours. If it doesn't, the dose was too high, which is information rather than failure."
---
