...
faq:
  - question: "Why does my neck hurt from working at a desk?"
    answer: "Because the deep neck flexors that hold your head over your shoulders fatigue, and the head drifts forward toward the monitor. Every inch forward multiplies the load the muscles at the back of the neck have to hold all day. The ache is usually endurance failure in the small stabilizers rather than damage."
  - question: "How do I test my neck at home?"
    answer: "Three checks. A chin tuck endurance hold for the deep neck flexors, a cervical range of motion screen for rotation and side bend, and a wall posture test for how far forward the head sits at rest. The endurance test is usually the one that fails first in desk workers."
  - question: "Will a better chair or monitor fix my neck pain?"
    answer: "It helps and it rarely finishes the job. Ergonomics changes the load; it doesn't build the endurance that holds your head up once you stop thinking about it. Most people need both, and the strengthening is the part that keeps working after the novelty of the new setup wears off."
  - question: "When is neck pain a reason to see a doctor?"
    answer: "Numbness, tingling, or weakness running into the arm or hand. Pain following a fall or collision. Headaches that are new, severe, or different from your usual. Any of those want a clinical assessment rather than a home routine."
---
