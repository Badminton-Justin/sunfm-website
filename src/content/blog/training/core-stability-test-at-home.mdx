...
faq:
  - question: "How do I test core stability at home?"
    answer: "Three checks. Dead bug coordination, where a pass is six controlled reps per side with the low back pinned to the floor the whole time. A side plank hold, where a pass is 45 seconds or more each side with less than ten seconds difference between sides. And a bird dog hold for control. If the low back lifts on the first dead bug rep, that's a fail."
  - question: "Is core stability the same as having strong abs?"
    answer: "No, and this is the confusion behind most wasted core training. Stability is the ability to resist unwanted movement at the spine while your limbs move. Crunches train the muscles that create flexion, which is the opposite job. Someone can do fifty sit-ups and still fail a dead bug."
  - question: "How long should I be able to hold a side plank?"
    answer: "Forty-five seconds or more per side is the bar I use, with less than a ten-second difference between left and right. The asymmetry matters as much as the number. A big gap between sides usually shows up later as one-sided back or hip complaints."
  - question: "Why does my low back hurt during core exercises?"
    answer: "Usually because the deep core isn't holding the spine still, so the low back extensors take over and end up doing a job they weren't built for. That's the pattern a dead bug is testing for. If your back arches off the floor as soon as your leg extends, reduce the range until you can keep it pinned, then build from there."
---
