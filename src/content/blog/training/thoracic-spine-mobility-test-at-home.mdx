...
Pick your worst test from above and start with the drills that target that pattern. I've marked which drills attack which restriction. Squat University has a good overview of [why thoracic mobility matters for lifting](https://squatuniversity.com/2018/08/25/how-to-improve-thoracic-spine-mobility/) if you want the rationale beyond what I cover here.
