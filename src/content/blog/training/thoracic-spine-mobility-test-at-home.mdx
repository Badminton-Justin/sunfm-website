...
faq:
  - question: "How do I test thoracic spine mobility at home?"
    answer: "Three checks. A wall angel test, where a pass is hands reaching overhead with elbows nearly straight and the low back staying flat. A seated rotation test, where a pass is rotating about 45 degrees or more in each direction. And a cat-cow segmentation check for whether the mid-back moves segment by segment or as one block."
  - question: "What does a stiff thoracic spine cause?"
    answer: "Mostly it gets paid for by the neighbours. Overhead reaching that the mid-back can't supply gets taken from the shoulders or the low back. Rotation that the mid-back can't supply gets taken from the lumbar spine. Stiff T-spine is one of the more common reasons desk workers end up with shoulder and neck complaints that don't resolve with local treatment."
  - question: "How often should I do thoracic mobility drills?"
    answer: "Daily, in short doses. Five minutes most days beats thirty minutes on Sunday, because the stiffness is being reinforced eight hours a day at a desk. A few reps between meetings is a legitimate dose."
  - question: "Is thoracic stiffness reversible after 40?"
    answer: "Yes, though it takes longer than it would have at 25 and it holds better if you keep doing the work. The mid-back responds to extension and rotation loading at any age. What changes with time is how quickly it stiffens back up once you stop, not whether it improves in the first place."
---
