...
faq:
  - question: "How do I test hip mobility at home?"
    answer: "Four checks that take about five minutes. Supine hip flexion, where a pass is the knee coming within a few inches of your chest without the other leg lifting. A modified Thomas test for hip extension, where a pass is the lowered thigh resting flat or slightly below horizontal with no low-back arching. A 90/90 seated rotation. And butterfly depth."
  - question: "What does tight hip flexors actually mean?"
    answer: "It means the muscles at the front of the hip have adapted to the shortened position you hold them in while sitting, and no longer let the hip extend fully behind you. The modified Thomas test is what exposes it. The cost shows up as a low back that arches to make up the missing range, which is where a lot of desk-worker back ache comes from."
  - question: "How often should I do hip mobility work?"
    answer: "Daily beats occasional by a wide margin for this one, because sitting is a daily input. Five to ten minutes most days will move the test scores. A single long session once a week generally won't, because you're undoing eight hours of positioning each day."
  - question: "Can tight hips cause knee or back pain?"
    answer: "They can contribute. The hip sits between the knee and the low back, and when it doesn't move well, both neighbours tend to pick up movement they weren't designed for. That's why knee pain in desk workers so often improves when hip range and glute strength improve, without anything being done to the knee itself."
---
...
If you failed the Thomas test, your lower back pain probably isn't a back problem. It's a hip flexor problem. Stretching your back won't fix it. Opening up the front of the hip and waking up the glutes will. If the ache is one-sided and sits right at the dimple above your glute rather than centered on your spine, it's worth running the [SI joint self-tests](/training/si-joint-pain-when-sitting-at-a-desk-self-test) too, since tight hip flexors and SI joint pain share the same root cause and often show up together.
