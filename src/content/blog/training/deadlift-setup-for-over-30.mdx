...
faq:
  - question: "How do I set up for a deadlift correctly?"
    answer: "Bar over midfoot, shins close, hips at the height where your back can stay neutral, lats engaged so the bar stays against you, then take the slack out before you pull. The setup determines the rep. Most bad deadlifts are decided before the bar moves."
  - question: "Should I deadlift if I have tight hamstrings or hips?"
    answer: "Often yes, with a variation that fits your current range. A trap bar, elevated pulls, or a Romanian deadlift all load the hinge without demanding the hip and ankle range a conventional pull from the floor does. Forcing a conventional setup you don't have the mobility for is how backs get rounded under load."
  - question: "Is deadlifting safe after 30 or 40?"
    answer: "Loading a hinge pattern is one of the more useful things you can do for a body that sits all day, and age itself isn't a contraindication. What changes is that the setup and load progression matter more, because there's less margin for a sloppy rep than there was at 22."
  - question: "What are the most common deadlift setup mistakes?"
    answer: "Starting with the bar too far from the shins, setting the hips too low so it becomes a squat, and pulling into slack so the bar jerks off the floor. Each one costs either range, leverage, or back position, and all three are fixed before the lift rather than during it."
---
...
**Step 4: Brace and set the lats.** Take a breath into your stomach (not your chest), brace your abs like you're about to be punched, and squeeze your armpits down toward your hips. This activates the lats and locks the bar against your body, which is the single most underrated technical cue in the lift. If the brace itself feels foreign or weak, that's usually a breathing pattern problem rather than a strength problem, and I wrote up [how to breathe during heavy lifts](/training/how-to-breathe-during-heavy-lifts) as a separate piece for fixing it.
