...
faq:
  - question: "Why do my knees hurt when sitting at a desk?"
    answer: "Usually not because of the knee. Prolonged sitting shortens the hip flexors and switches down the glutes, which changes how the thigh tracks over the shin. Add limited ankle dorsiflexion and the knee absorbs load it isn't positioned to handle. The ache that shows up after long calls is typically a hip and ankle problem expressing itself at the knee."
  - question: "How can I tell what's causing my knee pain at home?"
    answer: "Three checks. A knee-to-wall ankle test for dorsiflexion, a single-leg squat for how the knee tracks over the foot, and a modified Thomas test for hip flexor length. Whichever scores worst is usually the one driving the knee complaint, and it's the one worth working on first."
  - question: "When should I see a doctor about knee pain?"
    answer: "Sharp stabbing pain that comes on suddenly, pain that wakes you at night, visible swelling, the knee feeling like it might give way on stairs, or the knee locking mid-bend. Any of those want a clinical assessment before loaded exercise. Pain that has clearly worsened over a month despite rest also warrants a visit."
  - question: "Does sitting cause permanent knee damage?"
    answer: "There's no good evidence that desk sitting damages the knee joint itself. What it reliably does is change the strength and range around the joint, and that is addressable. Most desk-worker knee ache improves within two to three weeks of consistent hip, ankle, and glute work."
---
...
If your single-leg squat had clear knee cave, your knees are paying for weak glute control. If you want to confirm that before you start, the [three-part glute activation test](/training/glute-activation-test-at-home-dead-butt-syndrome) scores it directly. Glute activation work and step-down progressions move this fastest, usually inside three weeks.
...
If what comes back is osteoarthritis, that isn't a reason to stop training, and I went through [what the research says about loading an arthritic knee](/training/strength-training-with-knee-osteoarthritis-after-50) separately, including why the imaging findings and the pain often don't match.
...
If you've worked through this and the pain isn't moving, that's the moment for professional eyes on it. That's also what [one-on-one training](/#apply) is for. I've logged over 12,000 sessions, most with desk workers across San Jose, [Santa Clara](/santa-clara-personal-trainer), and the Bay Area. Knee pain that traces to upstream issues is on the short list of what I work on the most. The fix is rarely the knee itself, but it has to be specific to your chain, not a generic routine.
