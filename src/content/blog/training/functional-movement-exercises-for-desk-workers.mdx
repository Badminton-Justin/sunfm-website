...
faq:
  - question: "What are functional movement exercises?"
    answer: "Movements that train patterns you actually use outside the gym: hinging, squatting, pushing, pulling, carrying, and rotating. For desk workers the value is that they load the positions sitting takes away, rather than isolating muscles that aren't the problem."
  - question: "What does sitting all day actually do to your body?"
    answer: "Hip flexors shorten from being held bent, glutes reduce their activation from disuse, the chest and front shoulder tighten from reaching for a keyboard, and the thoracic spine stiffens into a rounded position. Those four together are the shape most desk workers walk in with."
  - question: "How often should desk workers do mobility and strength work?"
    answer: "Most days, in small doses, beats a single long weekly session. Sitting is a daily input, so the counter-input works better daily too. A full routine two or three times a week plus short daily movement covers most people."
  - question: "Will stretching fix posture from desk work?"
    answer: "Stretching alone rarely holds. What's tight is only half the picture; the muscles that should hold the better position have usually gone weak, and stretching doesn't address that. The combination of mobilizing what's short and strengthening what's long is what makes a change stick."
---
...
Chest and front shoulders tighten from typing. Over months and years, the chest shortens while the upper back weakens, and you end up with the [forward-rounded posture](/training/posture-self-check-at-home) you see on half the people in any Silicon Valley coffee shop. If you want to know exactly which pieces of the pattern have set in for you, that link runs through a four-test self-check you can do at home in five minutes.
...
Five minutes of stretching isn't going to undo this. You need to [strengthen](/training/strength-training-for-longevity-beginners-guide-over-30) the stuff that's gone weak while mobilizing the stuff that's gone tight, and you need to do both regularly. That's what the routine below is built around, and it's also why [mobility and strength work aren't competing priorities](/training/mobility-vs-strength-training-why-you-need-both) in the first place.
...
This routine is what I've landed on after thousands of sessions with Bay Area professionals. It works at home, in a regular gym, or in a conference room if you close the door. Thirty-five to forty minutes start to finish. If you don't have dumbbells or kettlebells yet, the [15-minute resistance band routine](/training/resistance-band-routine-desk-workers-no-equipment) covers the same three patterns with a single band you can keep in a desk drawer.
