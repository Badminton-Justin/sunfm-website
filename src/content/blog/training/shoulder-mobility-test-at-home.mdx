...
faq:
  - question: "How do I test shoulder mobility at home?"
    answer: "Three checks. The Apley scratch test, where a pass is fingers touching behind the back on both sides or coming within an inch. A wall flexion test, where a pass is the backs of the hands touching the wall overhead with elbows nearly straight and the low back pinned. And a prone shoulder reach. A gap over four inches, or a side-to-side difference over two inches, is a fail."
  - question: "Why do my shoulders feel tight from desk work?"
    answer: "Because the chest and front shoulder spend the day shortened over a keyboard while the upper back muscles that pull the shoulders back sit long and underused. Over months that becomes the rounded position you see everywhere. The shoulder joint itself is often fine; the tissue around it has adapted to the posture."
  - question: "Is shoulder tightness the same as shoulder impingement?"
    answer: "No. General tightness is a range problem with no pain. Impingement is pain in a specific arc of overhead motion, usually between 60 and 120 degrees. If raising your arm hurts in a band and then eases past it, that's a different question from simply not having full range, and it wants a different self-check."
  - question: "How long does it take to improve shoulder mobility?"
    answer: "Two to three weeks of daily work usually moves the wall test. Progress tends to be faster than hips or ankles because the shoulder has more soft-tissue contribution and less bony restriction, but it also regresses faster if you stop, since the desk posture doesn't change."
---
...
The combined result is what trainers and PTs call upper crossed syndrome. Tight on the front, weak on the back, shoulders rolled, head jutted forward. It's the body's adaptation to the laptop, and once it sets in, it cascades into [impingement](/training/shoulder-impingement-for-desk-workers-self-check), neck pain, headaches, and that nagging knot between the shoulder blades that no amount of foam rolling fixes.

This post is about mobility and tightness, not pain. If reaching overhead actually hurts rather than just feeling stiff, the [shoulder impingement self-checks](/training/shoulder-impingement-for-desk-workers-self-check) or the [frozen shoulder vs. impingement](/training/frozen-shoulder-vs-shoulder-impingement-self-check) post will get you a more useful answer than this one.
