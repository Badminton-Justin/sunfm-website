...
faq:
  - question: "How do I tell if I have flat feet or high arches at home?"
    answer: "Wet the sole of one foot and step onto a dry surface that shows the print. A normal arch leaves a curved band along the inside edge, roughly a third to half the width of your heel print, connecting front and back. A flat arch leaves a middle band nearly as wide as the heel and forefoot. A high arch leaves barely any connection at all, sometimes a thin sliver or a complete gap."
  - question: "What is a normal navicular drop measurement?"
    answer: "Five to nine millimeters, roughly a quarter inch or a bit more, measured as the change in navicular height between sitting and standing. More than that suggests the arch is collapsing under load rather than holding its shape."
  - question: "Do I need orthotics if I have flat feet?"
    answer: "Not automatically. Flat feet that are flexible, pain-free, and strong through the foot often need arch control training rather than a support that does the job for them. Orthotics earn their place when there's pain that hasn't responded to strengthening, or a rigid deformity. That's a conversation with a podiatrist, not a decision to make from a wet footprint."
  - question: "How do I strengthen my foot arch?"
    answer: "The short-foot exercise is the main one: without curling your toes, draw the ball of the foot toward the heel so the arch lifts slightly, hold 5 to 10 seconds, repeat. Add toe splaying and towel scrunches. Two or three minutes a day barefoot does more than any single stretch."
---
