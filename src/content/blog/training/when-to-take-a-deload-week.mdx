...
faq:
  - question: "What is a deload week?"
    answer: "A planned week of reduced training stress, usually by cutting load, volume, or both, while keeping the movement patterns. It's not time off. The point is to let accumulated fatigue clear so the fitness you've built underneath it can show up."
  - question: "How do I know if I need a deload?"
    answer: "The common signals are lifts drifting down while effort feels higher, joints aching more than usual, sleep getting worse, and motivation dropping off a cliff. One of those on its own is noise. Two or three together for more than a week is a deload conversation."
  - question: "How often should you deload after 30?"
    answer: "It depends far more on how hard you've been training than on the calendar. People running genuinely hard programs need them more often than people training three moderate days a week, and some lifters rarely need a scheduled one at all because their week already self-regulates."
  - question: "What should I do during a deload week?"
    answer: "Keep training, just lighter. The three usual levers are cutting the weight, cutting the sets, or cutting the frequency, and which one you pick depends on what's beaten up. Complete rest is occasionally right, but for most people it removes the movement they actually want to keep."
---
