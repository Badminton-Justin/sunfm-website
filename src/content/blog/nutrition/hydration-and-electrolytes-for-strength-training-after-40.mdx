...
faq:
  - question: "Do I need electrolyte drinks for lifting?"
    answer: "For a typical hour-long lifting session in air conditioning, plain water is usually fine. Electrolytes start earning their place with long sessions, heavy sweating, hot conditions, or if you're someone who finishes sessions with salt visible on your skin."
  - question: "Why do I get cramps during workouts?"
    answer: "Cramping has more than one cause and hydration is only one of them. Fatigue in the muscle itself is a common driver, as is doing more volume than that muscle is conditioned for. If cramps only show up on hot days or long sessions, fluid and sodium are worth looking at first."
  - question: "How much water should I drink on training days?"
    answer: "Enough that urine is pale through the day, with extra around the session rather than all at once. Chasing a fixed number of litres ignores body size, sweat rate, and the weather. Consistent through the day beats a large volume right before training."
  - question: "Does hydration change after 40?"
    answer: "Thirst becomes a less reliable signal with age, and total body water declines, so the same fluid loss represents a larger proportion of what you're carrying. Practically that means relying on habit and urine colour rather than waiting until you feel thirsty."
---
