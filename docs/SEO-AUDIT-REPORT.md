...
**GSC / GA4 / CrUX field data — third consecutive audit without it.** The ADC token on this machine exists but returns `401 CREDENTIALS_MISSING` for Search Console; it lacks the webmasters scope. Re-auth requires an interactive browser login:
